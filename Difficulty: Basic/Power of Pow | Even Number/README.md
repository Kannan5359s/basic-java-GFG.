<h2><a href="https://www.geeksforgeeks.org/problems/power-of-pow-even-number5440/1?page=1&category=Numbers&sortBy=submissions">Power of Pow | Even Number</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a single integer <strong>N</strong>, your task is to find the sum of the square of the first <strong>N even natural Numbers</strong>.</span><br>
&nbsp;</p>
